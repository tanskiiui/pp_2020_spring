...
#ifndef MODULES_TASK_1_TANSKII_U_MATRIX_MULTIPLY_MATRIX_MULTIPLY_H_
#define MODULES_TASK_1_TANSKII_U_MATRIX_MULTIPLY_MATRIX_MULTIPLY_H_
#include<vector>
#include <iostream>
...
#endif  // MODULES_TASK_1_TANSKII_U_MATRIX_MULTIPLY_MATRIX_MULTIPLY_H_